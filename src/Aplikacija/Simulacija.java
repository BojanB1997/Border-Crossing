...
public class Simulacija extends Thread {
    ...
    public void run() {
        ...
        PolicijskiTerminal pt1 = new PolicijskiTerminal(listaVozila, mapa, 53, pt1txt, vrijeme, opis);
        PolicijskiTerminal pt2 = new PolicijskiTerminal(listaVozila, mapa, 52, pt2txt, vrijeme, opis);
        PolicijskiTerminal pt3 = new PolicijskiTerminal(listaVozila, mapa, 50, pt3txt, vrijeme, opis);
        ...
        CarinskiTerminal ct1 = new CarinskiTerminal(listaVozila, mapa, 54, ct1txt, uredni, opis);
        CarinskiTerminal ct2 = new CarinskiTerminal(listaVozila, mapa, 51, ct2txt, uredni, opis);
